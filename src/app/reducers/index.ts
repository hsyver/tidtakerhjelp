...
import * as fromResultatliste from '../resultatliste/state/resultatliste.reducer';

export interface AppState {
  opprett: fromOpprett.State;
  paamelding: fromPaamelding.State;
  tider: fromTider.State;
  resultatliste: fromResultatliste.State;
}
...
export const reducers: ActionReducerMap<AppState> = {
  ...
  resultatliste: fromResultatliste.reducer
};
...
export const getResultatlisteState = (state: AppState) => state.resultatliste;
export const getResultatliste = createSelector(getResultatlisteState, fromResultatliste.getResultatliste);